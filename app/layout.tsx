...
export const metadata: Metadata = {
  title: "AVACORE — Panel de Operaciones",
  description: "Sistema de monitoreo y operaciones AVA Systems",
};
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es">
      ...
      <body className="font-sans bg-slate-bg text-text-primary antialiased">
        {children}
      </body>
    </html>
  );
